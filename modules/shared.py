...
options_templates.update(options_section(('sd', "Stable Diffusion"), {
    ...
    "img2img_fix_steps": OptionInfo(False, "With img2img and hires fix, do exactly the amount of steps the slider specifies (normally you'd do less with less denoising)."),
    "img2img_background_color": OptionInfo("#ffffff", "With img2img, fill image's transparent parts with this color.", ui_components.FormColorPicker, {}),
    "hires_smart_steps": OptionInfo(False, "With img2img and hires fix, calculate target steps using improved formula (experimental feature)."),
    "hires_smart_minsteps": OptionInfo(9, "Minimum steps for img2img and img2img phase of hires fix when improved formula is enabled", gr.Slider, {"minimum": 1, "maximum": 150, "step": 1}),
...
options_templates.update(options_section(('ui', "User interface"), {
    ...
    "embedded_pnginfo": OptionInfo(False, "Show \"PNG Info\" block in txt2img and img2img tabs (requires restart)"),

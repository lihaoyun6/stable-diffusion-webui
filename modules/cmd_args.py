...
parser.add_argument("--better-kdiffusion", action='store_true', help="Use wywywywy's k-diffusion fork instead of the original repository. It can improve the output of 'DPM++ 2M' and 'DPM++ 2M Karras' sampler.")
